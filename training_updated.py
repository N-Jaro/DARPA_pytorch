...
def main(args):
    ...
    with mlflow.start_run():
        ...
        checkpoint_callback = ModelCheckpoint(
            ...
            filename='u-transformer-{val/loss:.2f}',
            save_top_k=3,
            mode='min',
        )
        ...
        # train_dataset = PatchDataGenerator(data_dir=args.train_data_dir, patch_size=args.patch_size, overlap=args.overlap, 
        #                                    norm_type=args.norm_type, hue_factor=args.hue_factor, augment=args.augment,
        #                                    valid_patch_rate=args.valid_patch_rate)
        # val_dataset = PatchDataGenerator(data_dir=args.val_data_dir, patch_size=args.patch_size, overlap=args.overlap, 
        #                             norm_type=args.norm_type, hue_factor=args.hue_factor, augment=args.augment,
        #                             valid_patch_rate=args.valid_patch_rate)
        # train_loader = DataLoader(train_dataset, batch_size=args.batch_size, shuffle=True, num_workers=args.num_workers)
        # val_loader = DataLoader(val_dataset, batch_size=args.batch_size, shuffle=False, num_workers=args.num_workers)
